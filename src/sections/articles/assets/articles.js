const articles = [
  {
    ...
    content: require('./mds/building-a-micro-version-of-react-from-scratch.md'),
  ...
  },
  {
    ...
    content: require('./mds/how-to-use-font-awesome-pro-with-react.md'),
  ...
  },
  {
    ...
    content: require('./mds/why-array-sort-in-javascript-doesnt-sort-numbers.md'),
    tags: ['javascript', 'why']
  }
]
